...
st.title("📡 Syndikátny Feed Príležitostí")
...
for t in tickets:
    ...
    elapsed_min = None
    try:
        created_dt = datetime.datetime.fromisoformat(t["created_at"])
        elapsed_min = (datetime.datetime.now() - created_dt).total_seconds() / 60
    ...
    with st.container(border=True):
        ...
        top_c1.caption(f"{t['sport']} · {t['liga']} · autor: **{t['author']}**")
